...
final class GigaDrillAttributeBoost {
    ...
    static synchronized void update(ServerPlayerEntity player, int bonusLevels) {
        ...
        if (bonusLevels <= 0 || held.isEmpty() || !held.isIn(ItemTags.SHOVELS)) {
